...
export default function MusicCard({ name, primaryArtists, image, album, id }) {
  ...
  return (
    <div className="rounded-lg w-[255px] h-[400px] p-2 flex flex-col hover:brightness-90 hover:from-gray-800 hover:to-gray-950 hover:shadow-lg hover:shadow-green-900">
      ...
      <div className="flex flex-col font-sans flex-wrap gap-2 p-1">
        ...
        <div className="w-full h-auto flex items-center justify-between px-2 mt-3">
          <div className="rounded-full h-[50px] pl-1 bg-white w-[50px] flex justify-center items-center duration-300 transform">
            <FaPlay
              color="black"
              size={20}
              onClick={() => {
